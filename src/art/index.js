...
const data = {
  ...
  spendingsPerWeek: [
    ...
    {week: 1992, value: 80.80},
  ],

  spendingsLastMonth: [
    {"number":  8, "name": 'Budweiser'},
    {"number": 7, "name": 'Shock Top'},
    {"number": 16, "name": 'Budlight'},
    {"number": 23, "name": 'Stella Artois'},
    {"number": 42, "name": 'Labbat'},
    {"number":  4, "name": 'Misc'},
  ],
};
